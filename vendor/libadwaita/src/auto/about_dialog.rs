...
use crate::{Dialog, DialogPresentationMode, ffi};
use glib::{
...
glib::wrapper! {
    #[doc(alias = "AdwAboutDialog")]
    pub struct AboutDialog(Object<ffi::AdwAboutDialog, ffi::AdwAboutDialogClass>) @extends Dialog, gtk::Widget, @implements gtk::Buildable, gtk::ConstraintTarget, gtk::ShortcutManager;
...
impl AboutDialog {
    ...
    #[doc(alias = "adw_about_dialog_get_appdata_resource_path")]
    #[doc(alias = "get_appdata_resource_path")]
    #[doc(alias = "appdata-resource-path")]
    pub fn appdata_resource_path(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::adw_about_dialog_get_appdata_resource_path(
                self.to_glib_none().0,
            ))
        }
    }
    ...
    #[doc(alias = "adw_about_dialog_get_other_apps_title")]
    #[doc(alias = "get_other_apps_title")]
    #[doc(alias = "other-apps-title")]
    pub fn other_apps_title(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::adw_about_dialog_get_other_apps_title(
                self.to_glib_none().0,
            ))
        }
    }
    ...
    #[cfg(feature = "v1_10")]
    #[cfg_attr(docsrs, doc(cfg(feature = "v1_10")))]
    #[doc(alias = "adw_about_dialog_set_other_apps_title")]
    #[doc(alias = "other-apps-title")]
    pub fn set_other_apps_title(&self, title: &str) {
        unsafe {
            ffi::adw_about_dialog_set_other_apps_title(
                self.to_glib_none().0,
                title.to_glib_none().0,
            );
        }
    ...
    #[cfg_attr(docsrs, doc(cfg(feature = "v1_10")))]
    #[doc(alias = "other-apps-title")]
    pub fn connect_other_apps_title_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_other_apps_title_trampoline<F: Fn(&AboutDialog) + 'static>(
            this: *mut ffi::AdwAboutDialog,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                c"notify::other-apps-title".as_ptr(),
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
                    notify_other_apps_title_trampoline::<F> as *const (),
                )),
                Box_::into_raw(f),
            )
        }
...
impl AboutDialogBuilder {
    ...
    #[cfg(feature = "v1_9")]
    #[cfg_attr(docsrs, doc(cfg(feature = "v1_9")))]
    pub fn appdata_resource_path(self, appdata_resource_path: impl Into<glib::GString>) -> Self {
        Self {
            builder: self
                .builder
                .property("appdata-resource-path", appdata_resource_path.into()),
        }
    }
    ...
    #[cfg(feature = "v1_10")]
    #[cfg_attr(docsrs, doc(cfg(feature = "v1_10")))]
    pub fn other_apps_title(self, other_apps_title: impl Into<glib::GString>) -> Self {
        Self {
            builder: self
                .builder
                .property("other-apps-title", other_apps_title.into()),
        }
    }
