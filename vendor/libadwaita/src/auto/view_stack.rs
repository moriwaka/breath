...
glib::wrapper! {
    #[doc(alias = "AdwViewStack")]
    pub struct ViewStack(Object<ffi::AdwViewStack, ffi::AdwViewStackClass>) @extends gtk::Widget, @implements gtk::Buildable, gtk::ConstraintTarget;
    ...
    pub fn connect_enable_transitions_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                ...
                c"notify::enable-transitions".as_ptr(),
