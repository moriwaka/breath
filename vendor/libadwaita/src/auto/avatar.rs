...
glib::wrapper! {
    #[doc(alias = "AdwAvatar")]
    pub struct Avatar(Object<ffi::AdwAvatar, ffi::AdwAvatarClass>) @extends gtk::Widget, @implements gtk::Buildable, gtk::ConstraintTarget;
