...
glib::wrapper! {
    #[doc(alias = "AdwWrapBox")]
    pub struct WrapBox(Object<ffi::AdwWrapBox, ffi::AdwWrapBoxClass>) @extends gtk::Widget, @implements gtk::Buildable, gtk::ConstraintTarget, gtk::Orientable;
...
impl WrapBox {
    ...
    #[doc(alias = "adw_wrap_box_remove_all")]
    pub fn remove_all(&self) {
        unsafe {
            ffi::adw_wrap_box_remove_all(self.to_glib_none().0);
        }
    }
