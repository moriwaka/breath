...
use crate::{SidebarItem, SidebarMode, SidebarSection, ffi};
use glib::{
...
glib::wrapper! {
    #[doc(alias = "AdwSidebar")]
    pub struct Sidebar(Object<ffi::AdwSidebar, ffi::AdwSidebarClass>) @extends gtk::Widget, @implements gtk::Buildable, gtk::ConstraintTarget;
...
impl Sidebar {
    ...
    #[doc(alias = "adw_sidebar_get_prefix")]
    #[doc(alias = "get_prefix")]
    pub fn prefix(&self) -> Option<gtk::Widget> {
        unsafe { from_glib_none(ffi::adw_sidebar_get_prefix(self.to_glib_none().0)) }
    }
    ...
    #[cfg(feature = "v1_10")]
    #[cfg_attr(docsrs, doc(cfg(feature = "v1_10")))]
    #[doc(alias = "adw_sidebar_get_suffix")]
    #[doc(alias = "get_suffix")]
    pub fn suffix(&self) -> Option<gtk::Widget> {
        unsafe { from_glib_none(ffi::adw_sidebar_get_suffix(self.to_glib_none().0)) }
    }
    ...
    #[cfg(feature = "v1_10")]
    #[cfg_attr(docsrs, doc(cfg(feature = "v1_10")))]
    #[doc(alias = "adw_sidebar_set_prefix")]
    #[doc(alias = "prefix")]
    pub fn set_prefix(&self, prefix: Option<&impl IsA<gtk::Widget>>) {
        unsafe {
            ffi::adw_sidebar_set_prefix(
                self.to_glib_none().0,
                prefix.map(|p| p.as_ref()).to_glib_none().0,
            );
        }
    }
    ...
    #[cfg(feature = "v1_10")]
    #[cfg_attr(docsrs, doc(cfg(feature = "v1_10")))]
    #[doc(alias = "adw_sidebar_set_suffix")]
    #[doc(alias = "suffix")]
    pub fn set_suffix(&self, suffix: Option<&impl IsA<gtk::Widget>>) {
        unsafe {
            ffi::adw_sidebar_set_suffix(
                self.to_glib_none().0,
    ...
    #[cfg_attr(docsrs, doc(cfg(feature = "v1_10")))]
    #[doc(alias = "prefix")]
    pub fn connect_prefix_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_prefix_trampoline<F: Fn(&Sidebar) + 'static>(
            this: *mut ffi::AdwSidebar,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                c"notify::prefix".as_ptr(),
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
                    notify_prefix_trampoline::<F> as *const (),
                )),
                Box_::into_raw(f),
            )
        }
    ...
    #[cfg_attr(docsrs, doc(cfg(feature = "v1_10")))]
    #[doc(alias = "suffix")]
    pub fn connect_suffix_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_suffix_trampoline<F: Fn(&Sidebar) + 'static>(
            this: *mut ffi::AdwSidebar,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
                    notify_suffix_trampoline::<F> as *const (),
                )),
                Box_::into_raw(f),
            )
        }
...
impl SidebarBuilder {
    ...
    #[cfg(feature = "v1_10")]
    #[cfg_attr(docsrs, doc(cfg(feature = "v1_10")))]
    pub fn prefix(self, prefix: &impl IsA<gtk::Widget>) -> Self {
        Self {
            builder: self.builder.property("prefix", prefix.clone().upcast()),
        }
    }
