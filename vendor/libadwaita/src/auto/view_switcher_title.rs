...
glib::wrapper! {
    #[doc(alias = "AdwViewSwitcherTitle")]
    pub struct ViewSwitcherTitle(Object<ffi::AdwViewSwitcherTitle, ffi::AdwViewSwitcherTitleClass>) @extends gtk::Widget, @implements gtk::Buildable, gtk::ConstraintTarget;
...
impl ViewSwitcherTitle {
    ...
    pub fn connect_view_switcher_enabled_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                c"notify::view-switcher-enabled".as_ptr(),
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
