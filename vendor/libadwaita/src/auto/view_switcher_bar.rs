...
glib::wrapper! {
    #[doc(alias = "AdwViewSwitcherBar")]
    pub struct ViewSwitcherBar(Object<ffi::AdwViewSwitcherBar, ffi::AdwViewSwitcherBarClass>) @extends gtk::Widget, @implements gtk::Buildable, gtk::ConstraintTarget;
