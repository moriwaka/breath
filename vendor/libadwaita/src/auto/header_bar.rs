...
glib::wrapper! {
    #[doc(alias = "AdwHeaderBar")]
    pub struct HeaderBar(Object<ffi::AdwHeaderBar, ffi::AdwHeaderBarClass>) @extends gtk::Widget, @implements gtk::Buildable, gtk::ConstraintTarget;
...
impl HeaderBar {
    ...
    pub fn connect_centering_policy_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(
                ...
                c"notify::centering-policy".as_ptr(),
    ...
    pub fn connect_show_back_button_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                c"notify::show-back-button".as_ptr(),
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
