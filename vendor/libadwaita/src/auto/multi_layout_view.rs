...
glib::wrapper! {
    #[doc(alias = "AdwMultiLayoutView")]
    pub struct MultiLayoutView(Object<ffi::AdwMultiLayoutView, ffi::AdwMultiLayoutViewClass>) @extends gtk::Widget, @implements gtk::Buildable, gtk::ConstraintTarget;
