...
use crate::{NavigationDirection, ffi};
...
glib::wrapper! {
    #[doc(alias = "AdwSwipeable")]
    pub struct Swipeable(Interface<ffi::AdwSwipeable, ffi::AdwSwipeableInterface>) @requires gtk::Widget, gtk::Buildable, gtk::ConstraintTarget;
