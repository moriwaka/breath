...
glib::wrapper! {
    #[doc(alias = "AdwCarouselIndicatorDots")]
    pub struct CarouselIndicatorDots(Object<ffi::AdwCarouselIndicatorDots, ffi::AdwCarouselIndicatorDotsClass>) @extends gtk::Widget, @implements gtk::Buildable, gtk::ConstraintTarget, gtk::Orientable;
