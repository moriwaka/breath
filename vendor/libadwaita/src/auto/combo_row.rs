...
glib::wrapper! {
    #[doc(alias = "AdwComboRow")]
    pub struct ComboRow(Object<ffi::AdwComboRow, ffi::AdwComboRowClass>) @extends ActionRow, PreferencesRow, gtk::ListBoxRow, gtk::Widget, @implements gtk::Buildable, gtk::ConstraintTarget, gtk::Actionable;
...
pub trait ComboRowExt: IsA<ComboRow> + 'static {
    ...
    fn connect_header_factory_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                c"notify::header-factory".as_ptr(),
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
    ...
    fn connect_search_match_mode_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                c"notify::search-match-mode".as_ptr(),
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
