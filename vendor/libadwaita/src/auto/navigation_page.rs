...
glib::wrapper! {
    #[doc(alias = "AdwNavigationPage")]
    pub struct NavigationPage(Object<ffi::AdwNavigationPage, ffi::AdwNavigationPageClass>) @extends gtk::Widget, @implements gtk::Buildable, gtk::ConstraintTarget;
