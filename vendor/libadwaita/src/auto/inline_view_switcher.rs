...
use crate::{InlineViewSwitcherDisplayMode, ViewStack, ffi};
use glib::{
    prelude::*,
...
glib::wrapper! {
    #[doc(alias = "AdwInlineViewSwitcher")]
    pub struct InlineViewSwitcher(Object<ffi::AdwInlineViewSwitcher, ffi::AdwInlineViewSwitcherClass>) @extends gtk::Widget, @implements gtk::Buildable, gtk::ConstraintTarget, gtk::Orientable;
