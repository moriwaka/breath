...
glib::wrapper! {
    #[doc(alias = "AdwBottomSheet")]
    pub struct BottomSheet(Object<ffi::AdwBottomSheet, ffi::AdwBottomSheetClass>) @extends gtk::Widget, @implements gtk::Buildable, gtk::ConstraintTarget, Swipeable;
...
impl BottomSheet {
    ...
    pub fn connect_bottom_bar_height_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                c"notify::bottom-bar-height".as_ptr(),
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
    ...
    pub fn connect_reveal_bottom_bar_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                c"notify::reveal-bottom-bar".as_ptr(),
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
    ...
    pub fn connect_show_drag_handle_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                c"notify::show-drag-handle".as_ptr(),
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
