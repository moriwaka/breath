...
glib::wrapper! {
    #[doc(alias = "AdwLeaflet")]
    pub struct Leaflet(Object<ffi::AdwLeaflet, ffi::AdwLeafletClass>) @extends gtk::Widget, @implements gtk::Buildable, gtk::ConstraintTarget, Swipeable, gtk::Orientable;
...
impl Leaflet {
    ...
    pub fn connect_can_navigate_back_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                ...
                c"notify::can-navigate-back".as_ptr(),
    ...
    pub fn connect_can_navigate_forward_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                c"notify::can-navigate-forward".as_ptr(),
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
    ...
    pub fn connect_child_transition_params_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                c"notify::child-transition-params".as_ptr(),
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
    ...
    pub fn connect_child_transition_running_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                c"notify::child-transition-running".as_ptr(),
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
    ...
    pub fn connect_mode_transition_duration_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                c"notify::mode-transition-duration".as_ptr(),
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
