...
use crate::{LengthUnit, NavigationPage, ffi};
use glib::{
    prelude::*,
...
glib::wrapper! {
    #[doc(alias = "AdwNavigationSplitView")]
    pub struct NavigationSplitView(Object<ffi::AdwNavigationSplitView, ffi::AdwNavigationSplitViewClass>) @extends gtk::Widget, @implements gtk::Buildable, gtk::ConstraintTarget;
