...
use crate::Banner;
use crate::{PreferencesGroup, ffi};
use glib::{
    prelude::*,
...
glib::wrapper! {
    #[doc(alias = "AdwPreferencesPage")]
    pub struct PreferencesPage(Object<ffi::AdwPreferencesPage, ffi::AdwPreferencesPageClass>) @extends gtk::Widget, @implements gtk::Buildable, gtk::ConstraintTarget;
...
pub trait PreferencesPageExt: IsA<PreferencesPage> + 'static {
    ...
    fn connect_description_centered_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                c"notify::description-centered".as_ptr(),
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
