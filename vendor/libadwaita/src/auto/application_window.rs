...
glib::wrapper! {
    #[doc(alias = "AdwApplicationWindow")]
    pub struct ApplicationWindow(Object<ffi::AdwApplicationWindow, ffi::AdwApplicationWindowClass>) @extends gtk::ApplicationWindow, gtk::Window, gtk::Widget, @implements gtk::Buildable, gtk::ConstraintTarget, gtk::Native, gtk::Root, gtk::ShortcutManager, gio::ActionGroup, gio::ActionMap;
...
pub trait AdwApplicationWindowExt: IsA<ApplicationWindow> + 'static {
    #[cfg(feature = "v1_4")]
    #[cfg_attr(docsrs, doc(cfg(feature = "v1_4")))]
    ...
    #[cfg(feature = "v1_7")]
    #[cfg_attr(docsrs, doc(cfg(feature = "v1_7")))]
    #[doc(alias = "adw_application_window_get_adaptive_preview")]
    #[doc(alias = "get_adaptive_preview")]
    #[doc(alias = "adaptive-preview")]
    fn is_adaptive_preview(&self) -> bool {
        unsafe {
            from_glib(ffi::adw_application_window_get_adaptive_preview(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    #[cfg(feature = "v1_7")]
    #[cfg_attr(docsrs, doc(cfg(feature = "v1_7")))]
    #[doc(alias = "adw_application_window_set_adaptive_preview")]
    #[doc(alias = "adaptive-preview")]
    fn set_adaptive_preview(&self, adaptive_preview: bool) {
        unsafe {
            ffi::adw_application_window_set_adaptive_preview(
                self.as_ref().to_glib_none().0,
    ...
    fn connect_adaptive_preview_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(
                ...
                c"notify::adaptive-preview".as_ptr(),
    ...
    fn connect_current_breakpoint_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                c"notify::current-breakpoint".as_ptr(),
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
    ...
    fn connect_visible_dialog_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                c"notify::visible-dialog".as_ptr(),
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
