...
glib::wrapper! {
    #[doc(alias = "AdwClampScrollable")]
    pub struct ClampScrollable(Object<ffi::AdwClampScrollable, ffi::AdwClampScrollableClass>) @extends gtk::Widget, @implements gtk::Buildable, gtk::ConstraintTarget, gtk::Orientable, gtk::Scrollable;
...
impl ClampScrollable {
    ...
    pub fn connect_tightening_threshold_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                c"notify::tightening-threshold".as_ptr(),
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
