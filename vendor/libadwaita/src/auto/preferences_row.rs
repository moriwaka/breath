...
glib::wrapper! {
    #[doc(alias = "AdwPreferencesRow")]
    pub struct PreferencesRow(Object<ffi::AdwPreferencesRow, ffi::AdwPreferencesRowClass>) @extends gtk::ListBoxRow, gtk::Widget, @implements gtk::Buildable, gtk::ConstraintTarget, gtk::Actionable;
...
pub trait PreferencesRowExt: IsA<PreferencesRow> + 'static {
    ...
    fn connect_title_selectable_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                c"notify::title-selectable".as_ptr(),
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
