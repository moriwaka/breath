...
use crate::{ViewStack, ViewSwitcherPolicy, ffi};
use glib::{
    prelude::*,
...
glib::wrapper! {
    #[doc(alias = "AdwViewSwitcher")]
    pub struct ViewSwitcher(Object<ffi::AdwViewSwitcher, ffi::AdwViewSwitcherClass>) @extends gtk::Widget, @implements gtk::Buildable, gtk::ConstraintTarget;
