...
glib::wrapper! {
    #[doc(alias = "AdwBreakpointBin")]
    pub struct BreakpointBin(Object<ffi::AdwBreakpointBin, ffi::AdwBreakpointBinClass>) @extends gtk::Widget, @implements gtk::Buildable, gtk::ConstraintTarget;
