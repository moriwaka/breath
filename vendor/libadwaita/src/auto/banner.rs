...
glib::wrapper! {
    #[doc(alias = "AdwBanner")]
    pub struct Banner(Object<ffi::AdwBanner, ffi::AdwBannerClass>) @extends gtk::Widget, @implements gtk::Buildable, gtk::ConstraintTarget, gtk::Actionable;
...
impl Banner {
    ...
    #[cfg(feature = "v1_7")]
    #[cfg_attr(docsrs, doc(cfg(feature = "v1_7")))]
    #[doc(alias = "adw_banner_get_button_style")]
    #[doc(alias = "get_button_style")]
    #[doc(alias = "button-style")]
    pub fn button_style(&self) -> BannerButtonStyle {
        unsafe { from_glib(ffi::adw_banner_get_button_style(self.to_glib_none().0)) }
    }
    ...
    #[cfg(feature = "v1_7")]
    #[cfg_attr(docsrs, doc(cfg(feature = "v1_7")))]
    #[doc(alias = "adw_banner_set_button_style")]
    #[doc(alias = "button-style")]
    pub fn set_button_style(&self, style: BannerButtonStyle) {
        unsafe {
            ffi::adw_banner_set_button_style(self.to_glib_none().0, style.into_glib());
        }
    }
    ...
    #[cfg_attr(docsrs, doc(cfg(feature = "v1_7")))]
    #[doc(alias = "button-style")]
    pub fn connect_button_style_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_button_style_trampoline<F: Fn(&Banner) + 'static>(
            this: *mut ffi::AdwBanner,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                c"notify::button-style".as_ptr(),
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
                    notify_button_style_trampoline::<F> as *const (),
                )),
                Box_::into_raw(f),
            )
        }
...
impl BannerBuilder {
    ...
    #[cfg(feature = "v1_7")]
    #[cfg_attr(docsrs, doc(cfg(feature = "v1_7")))]
    pub fn button_style(self, button_style: BannerButtonStyle) -> Self {
        Self {
            builder: self.builder.property("button-style", button_style),
        }
    }
